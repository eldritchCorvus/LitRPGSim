	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				frames = tex;
				animation.addByPrefix('idle', 'ShadowIdle', 24);
				animation.addByPrefix('singUP', 'ShadowUp', 24);
				animation.addByPrefix('singRIGHT', 'ShadowRight', 24);
				animation.addByPrefix('singDOWN', 'ShadowDown', 24);
				animation.addByPrefix('singLEFT', 'ShadowLeft', 24);
			...
			case 'watt':
				frames = Paths.getSparrowAtlas('watt/watt_assets');
				animation.addByPrefix('idle', 'WattIdle', 24, false);
				//now this here is the world's jankiest fix for the weird idle offset, but lol, works for now
				//watt lost his adderall before this rap battle, just roll with it
				animation.addByPrefix('singUP', 'WattUp', 24, false);
				animation.addByPrefix('singDOWN', 'WattDown', 24, false);
				animation.addByPrefix('singLEFT', 'WattLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'WattRight', 24, false);
				
				addOffset('idle');
				addOffset("singUP", 0, 400);
				addOffset("singRIGHT", -80, -40);
				addOffset("singLEFT", 120, -40);

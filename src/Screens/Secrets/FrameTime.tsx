...
export const FrameTime =()=>{
    return(
        <Fragment>
                    ...
                    <div><a target="_blank" rel="noreferrer" href="https://github.com/FarragoFiction/LitRPGSim/blob/master/src/Screens/Secrets/JustRefs: #22917.tsx">View My Soul 1</a></div>
                    ...
                    <a  target="_blank" rel="noreferrer" href={`?seed=0&jr=Refs: #22917`}>Or go talk to JR.</a>

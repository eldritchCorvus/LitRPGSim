...
//the point of ThisIsAGame is to punish the player for forcing dear sweet precious Refs: #22917 to lie like that and pretend to be a game
//horror jail for you.
interface RoomProps {
...
`;
  ...
  const checkSnark = (input: string) => {
    ...
    const help_euphemisms = ["HELP", "LOST", "OPERATOR", "ASSIST", "AID", "SUPPORT", "Refs: #22917"];

...
export function initAspects(seeded_random: SeededRandom){
    ...
    new Aspect("spiral", ["Spiral", "Sand", "Lies", "Confusion ","Gaslighting","Tricks","Deception","Madness","Fractals","Chaos","Labyrinths","Mazes","Twisting","Laughter"], seeded_random, Stat.WrapStatsToStatMap([Stat.RAGE(3)]), [all_themes[TWISTING], all_themes[OBFUSCATION]]);

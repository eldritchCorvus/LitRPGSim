...
export function initAspects(seeded_random: SeededRandom){
    ...
    //the child of fate
    new Aspect("corruption", ["Decay","Mold","Disease","Sickness","Love", "Corruption", "Toxicity", "Inserts", "Plague","Rot","Disgust","Bugs","Maggots","Worms","Filth"], seeded_random, Stat.WrapStatsToStatMap([Stat.DOOM(1),Stat.LIFE(1),Stat.HEART(1)]), [all_themes.decay, all_themes.bugs,all_themes.love]);

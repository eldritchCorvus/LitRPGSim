...
export function initAspects(seeded_random: SeededRandom){
    ...
    new Aspect("spiral", ["insomniac","typoe","Dionysus","Spiral", "Sand", "Lies", "Confusion ","Gaslighting","Tricks","Deception","Madness","Fractals","Chaos","Labyrinths","Mazes","Twisting","Laughter", "Distortion","Tricks"], seeded_random, Stat.WrapStatsToStatMap([Stat.RAGE(3)]), [all_themes[TWISTING], all_themes[OBFUSCATION]]);

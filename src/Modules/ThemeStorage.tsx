...
export interface ThemePossibilitiesNumberMap {
    [details: string]: number;
}

export interface ThemeOpinions {
    [details: string]: ThemePossibilitiesNumberMap;
}
...
const initFloorForegrounds = () => {
    ...
    floor_foregrounds[ROYALTY] = [{ src: "Royal_Object.png", desc: "Long Live The... The... Is dead."},{ src: "jwelerybox.png", desc: "Crown jewels." }, { src: "pileofgold2.png", desc: "The wealth of an Empire." }, { src: "pileofgold1.png", desc: "The wealth of a kingdom." }, { src: "princessbed.png", desc: "A bed fit for royalty." }, { src: "smallgoldpile.png", desc: "The taxes you are due." }, { src: "throne.png", desc: "Your rightful place." }];
    floor_foregrounds[SCIENCE] = [{ src: "Science_Object.png", desc: "A beaker of perfectly generic fluid."},{ src: "smallbookshelf.png", desc: "Textbooks organized by scientific discipline line these shelves."}, { src: "science.png", desc: "Oh, the discoveries you could make with enough patience and equipment." }, { src: "morewine.png", desc: "You get the distinct urge to do science seeing this well stocked lab." }, { src: "jars.png", desc: "Specimen jars." }]
    ...
    floor_foregrounds[KILLING] = [{ src: "knife.png", desc: "Knife goes in. Blood comes out. It's that simple." }, { src: "violentbed.png", desc: "A fight happened here." }, { src: "webswords.png", desc: "There is clarity in killing. The why doesn't matter, only the how." }, { src: "swords.png", desc: "You could kill a lot of people with these." }, { src: "swordanvil.png", desc: "A weapon has only one purpose: killing." }, { src: "stumpwithax.png", desc: "You feel the inexplicable urge to write 'All Work And No Play Makes Johnny A Dull Boy' over and over again." }, { src: "pickax.png", desc: "You could really do some damage to someone's skull with this." }, { src: "choppingblock.png", desc: "You almost wish you weren't alone in this maze, just so you could test this knife out." }, { src: "boxoknives.png", desc: "You could really do some damage to someone with all these knives." }, { src: "bloodfountain.png", desc: "You feel the inexplicable urge to bathe in this." }];
    ...
    floor_foregrounds[TECHNOLOGY] =  [{ src: "laundry.png", desc: "Modern technology sure is convinient!"},{ src: "laptop.png", desc: "The battery seems to be completely dead."},{ src: "printer.png", desc: "You feel the irrational urge to destroy this flawless piece of technology."}] ;
    floor_foregrounds[SERVICE] = [{ src: "hydration_station.png", desc: "You wonder if anyone around here is thirsty..."},{ src: "cookingpot.png", desc: "Is it time for you to cook dinner?"},{ src: "plates.png", desc: "Are you supposed to clean these dishes?"},{ src: "laundry.png", desc: "You can't remember the last time you've done laundry."},{ src: "Service_Object.png", desc: "Ring Bell For Service."}];
    floor_foregrounds[ADDICTION] = [{ src: "webwine2.png", desc: "you really don't want to touch it."},{ src: "webwine.png", desc: "Its a good thing this wine looks so gross."},{ src: "wineshelves.png", desc: "You're not tempted by these."},{ src: "beer.png", desc: "Probably shouldn't."},{ src: "more_wine.png", desc: "Best not to."},{ src: "teapot.png", desc: "Caffeine is bad for you."},{ src: "Addiction_Object.png", desc: "A difficult subject."}];
...
const createOpinion = (baseline = 0, specificOpinions: ThemePossibilitiesNumberMap) => {
    const ret:ThemePossibilitiesNumberMap = {
        SPYING: baseline,
        LONELY: baseline,
        ART: baseline,
        TECHNOLOGY: baseline,

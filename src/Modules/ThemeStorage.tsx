...
export const CITYRefs: #22917E = "CITYRefs: #22917E";
...
export let super_Refs: #22917e_possibilities_map:ThemePossibilitiesMap = {};
...
export const checkIfAllKeysPresent = ()=>{
    for(let key of keys){
        ...
        if(!(key in super_Refs: #22917e_possibilities_map)){
            console.error("JR NOTE: key", key, "not found in super_Refs: #22917e_possibilities_map");
        }
...
const initPeople = () =>{
    ...
    person_posibilities[TWISTING] = ["therapist","Refs: #22917","devil","liar","madman"];
    ...
    person_posibilities[KNOWING] = ["instinct","knowledge","Refs: #22917","gnosis","awareness","sense","idea"];
...
const initSuperRefs: #22917es = () =>{
    super_Refs: #22917e_possibilities_map[ART] =  ["Perfect Moment"];
    super_Refs: #22917e_possibilities_map[TECHNOLOGY] =  ["Singularity"];
    super_Refs: #22917e_possibilities_map[TIME] =  ["Stopped Clock"];
    super_Refs: #22917e_possibilities_map[SPACE] =  ["Big Bang"];
    super_Refs: #22917e_possibilities_map[OCEAN] =  ["Ship of Vescillation"];
    super_Refs: #22917e_possibilities_map[LONELY] =  ["The Silence"];
    super_Refs: #22917e_possibilities_map[FIRE] =  ["The Scoured Earth"];
    super_Refs: #22917e_possibilities_map[FREEDOM] =  ["Unending Freedom"];
    super_Refs: #22917e_possibilities_map[STEALING] =  ["All Mine"];
    super_Refs: #22917e_possibilities_map[BURIED] =  ["Fallen Sky"];
    super_Refs: #22917e_possibilities_map[FLESH] =  ["Physical God"];
    super_Refs: #22917e_possibilities_map[SCIENCE] =  ["E=mc^2"];
    super_Refs: #22917e_possibilities_map[MATH] =  ["Calculus Pop Quiz"];
    super_Refs: #22917e_possibilities_map[TWISTING] =  ["This Is Not A Game"];
    super_Refs: #22917e_possibilities_map[DEATH] =  ["Your Grave"];
    super_Refs: #22917e_possibilities_map[APOCALYPSE] =  ["Ragnarok"];
    super_Refs: #22917e_possibilities_map[ANGELS] =  ["Judgement Day"];
    super_Refs: #22917e_possibilities_map[SERVICE] =  ["Special Service"];
    super_Refs: #22917e_possibilities_map[FAMILY] =  ["Sins of the Father"];
    super_Refs: #22917e_possibilities_map[MAGIC] =  ["Ritual of Ragnarok"];
    super_Refs: #22917e_possibilities_map[LIGHT] =  ["Flash Bang"];
    super_Refs: #22917e_possibilities_map[HEALING] =  ["Summon Phoenix"];
    super_Refs: #22917e_possibilities_map[PLANTS] = ["Forest's March"];
    super_Refs: #22917e_possibilities_map[HUNTING] = ["Nimrod's Chase"];
    super_Refs: #22917e_possibilities_map[DECAY] = ["Mass Grave"] ;
    super_Refs: #22917e_possibilities_map[CHOICES] =  ["Timeline of Theseus"] ;
    super_Refs: #22917e_possibilities_map[ZAP] = ["Thor's Banana"] ;
    super_Refs: #22917e_possibilities_map[LOVE] = ["Mandatory Shipping Grid"];
    super_Refs: #22917e_possibilities_map[SOUL] = ["Know thyself."] ;
    super_Refs: #22917e_possibilities_map[ANGER] = ["Dethrone Creation"] ;
    super_Refs: #22917e_possibilities_map[WEB] =  ["Puppet Master"] ;
    super_Refs: #22917e_possibilities_map[ROYALTY] =  ["Excalibur"] ;
    super_Refs: #22917e_possibilities_map[ENDINGS] =  ["The End"] ;
    super_Refs: #22917e_possibilities_map[KNOWING] = ["Omniscience"] ;
    super_Refs: #22917e_possibilities_map[GUIDING] = ["Path To Victory"] ;
    super_Refs: #22917e_possibilities_map[CRAFTING] =  ["Legendary Forge"];
    super_Refs: #22917e_possibilities_map[LANGUAGE] = ["Topple the Tower"] ;
    super_Refs: #22917e_possibilities_map[BUGS] =  ["Hivemother"];
    super_Refs: #22917e_possibilities_map[ADDICTION] = ["Dealer's Delight"];
    super_Refs: #22917e_possibilities_map[SPYING] =["Surveillance State"] ;
    super_Refs: #22917e_possibilities_map[CLOWNS] =["Ringmaster"] ;
    super_Refs: #22917e_possibilities_map[DOLLS] = ["Automatonophobia "] ;
    super_Refs: #22917e_possibilities_map[OBFUSCATION] = ["Knowledge Forever Lost"] ;
    super_Refs: #22917e_possibilities_map[DARKNESS] =  ["Night Eternal"] ;
    super_Refs: #22917e_possibilities_map[KILLING] =  ["Bloodbath"];
    super_Refs: #22917e_possibilities_map[MUSIC] =  ["Symphonic Synthesia"] ;
    super_Refs: #22917e_possibilities_map[DEFENSE] =  ["Excalibur"] ;
    super_Refs: #22917e_possibilities_map[QUESTING] = ["Satisfaction"] ;
}
...
const initMemories = () =>{
   ...
   //aww how cute they think of you as family
    ...
    //they really don't know why you'd still be here. poor Refs: #22917
    memories[KNOWING] = [
    ...
    memories[APOCALYPSE] =  [
        new Memory("Are you afraid of the end of the world?","Yeah, you should be.","Boring.","You understand how fragile the world truly is.","You choose blindness over the terrifying Refs: #22917 of the inevitability of the death of all.")
...
const initLocDesc = () =>{
    ...
    loc_desc[DEATH] =  ["a tombstone bearing your Refs: #22917e in the center","human remains strewn about","an urn of ashes that clearly had once been human"];
    ...
    loc_desc[ANGELS] =  ["statues of saints and angels everywhere you look","stained glass windows depecting religious scenes","an alter to a Refs: #22917eless god"];
    ...
    loc_desc[KNOWING] = ["a collection of every possible book that could ever be written somehow squeezed into just a few bookshelves","the sum of all human knowledge written impossibly small on every surface, if only you could read it","everything you could ever have wished to know about Zampanio and its Refs: #22917"] ;
    loc_desc[GUIDING] = ["a compass the size of a person, resolutely pointed towards where you have not yet gone","a map of all of Zampanio as it spirals in on itself, assuring you that nothing makes any geographic sense at all","a link to a guide to Zampanio at https://zampaniosim.fandom.com/wiki/ZampanioSim_Wiki , with a warning that it is written by liars and madmen and a plea to add to it yourself and cement Refs: #22917 inside of you"] ;
    loc_desc[CRAFTING] =  ["a forge heated to be white hot along one wall","an anvil that has broken in two in the center of the room","an intrict loom that appears to be weaving fate itself"];
...
const initMonsterDesc = () =>{
    ...
    monster_desc[KILLING] =  ["Its foot and hand prints are always fresh blood.","A tsuRefs: #22917i of blood follows in its wake.","It clutches various weapons in each hand.","Its dripping with killing intent.","It drags a fresh corpse behind it."];
...
const initEffectPossibilities = () =>{
    ...
    effect_possibilities[DEATH] =  ["small animal bones fall from the sky","a grave with your Refs: #22917e on it erupts from the ground like a jagged tooth","you see the date everything around you will die"];

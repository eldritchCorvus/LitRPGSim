...
const initSpritePossibilities=()=>{
    ...
    sprite_possibilities[TWISTING] =  [{left_src:"unknown.png",right_src:"unknown.png",up_src:"unknown.png",down_src:"unknown.png"},{left_src:"zampanio_flowerkid_by_hex2.png",right_src:"zampanio_flowerkid_by_hex2.png",up_src:"zampanio_flowerkid_by_hex2.png",down_src:"zampanio_flowerkid_by_hex2.png"},{left_src:"unknown.png",right_src:"zampanio_flowerkid_by_hex2.png",up_src:"Twisting_Crow.gif",down_src:"humanoid_crow.png"},{left_src:"Twisting_Crow.gif",right_src:"Twisting_Crow.gif",up_src:"Twisting_Crow.gif",down_src:"Twisting_Crow.gif"}];
}
...
const initFloorForegrounds = () => {
    ...
    floor_foregrounds[SERVICE] = [{ src: "Service_Object.png", desc: "Ring Bell For Service."}];
...
const initThemeOpinions = () => {
    ...
    theme_opinions[BUGS] =  ["gentle"];
    theme_opinions[ADDICTION] = ["compelling"];
    theme_opinions[CLOWNS] =["funny"] ;
    theme_opinions[DOLLS] = ["playful "] ;
    theme_opinions[OBFUSCATION] = ["mysterious"] ;
    theme_opinions[DARKNESS] =  ["quiet"] ;
    theme_opinions[KILLING] =  ["forthright"];
    theme_opinions[MUSIC] =  ["talented"] ;
    theme_opinions[DEFENSE] =  ["protective"] ;
    theme_opinions[QUESTING] = ["goal-oriented"] ;
    */
}

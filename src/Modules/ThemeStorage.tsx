...
const initMonsterDesc = () =>{
    ...
    monster_desc[LIGHT] =  ["A blinding light pulses out of it every minute or so.","Out of its eyes and mouth pour a blinding light.","Its entire body pulse with blinding brillance eveyr few seconds.","Its veins glow dangerously."];
    ...
    monster_desc[KNOWING] = ["It knows your every secret with unerring accuracy.","It clutches a stained and rotting book to its chest.","Somehow you know it used to be someone you knew very well."] ;

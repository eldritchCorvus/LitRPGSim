...
const initLocDesc = () =>{
    ...
    loc_desc[PLANTS] = ["ferns and gass as far as the eye can see, growing right out of the floor","potted plants lining the walls","an entire forest impossibly contained in a single room"];
    ...
    loc_desc[GUIDING] = ["a compass the size of a person, resolutely pointed towards where you have not yet gone","a map of all of Zampanio as it spirals in on itself, assuring you that nothing makes any geographic sense at all","a link to a guide to Zampanio at https://zampaniosim.fandom.com/wiki/ZampanioSim_Wiki , a  warning that it is written by liars and madmen and a plea to add to it yourself and cement Truth inside of you"] ;

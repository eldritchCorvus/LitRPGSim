...
export function initClasses(seeded_random: SeededRandom){
    ...
    new RPGClass("bard", ["Clown","Homer","Goose","Bard", "Singer", "Skald", "Teller", "Raconteur","Canary","Chinchilla"],-2.0, seeded_random, [all_themes.clowns, all_themes.language,all_themes.music]);
    ...
    new RPGClass("rogue", ["Conspiracist","Ferret","Rogue","Scoundrel","Villain", "Rascal", "Rat","Wretch","Reprobate"],2.0, seeded_random, [all_themes[STEALING],all_themes[HUNTING]]);

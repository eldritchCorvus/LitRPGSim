...
export const wasteHackingFunctions = ["hackSkillPointsGainedFromBattle","hackCityMorale","hackStatisticsMenuLevel","hackOptionsMenuLevel","hackTimePlayedInSeconds","hackTimeCombatInSeconds","hackTimeCutscenesInSeconds","hackTimeCitybuildingInSeconds"];

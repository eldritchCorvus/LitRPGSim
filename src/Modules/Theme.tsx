...
export function initThemes(){
    ...
    new Theme("killing", 0,Stat.WrapStatsToStatMap([Stat.RAGE(1)]),["Assasin's Stance","Bloodlust"],["Killing", "Murder","Slaughter","Massacre","Blade","Gun"],["Death", "Violence", "Blades","Guns"],["Total War"]);
    new Theme("music", 0,Stat.WrapStatsToStatMap([Stat.HOPE(1)]),["Starting Sonata","Dancing Ditty"],["Fortississimo", "Leitmotif", "Liberetto", "Sarabande", "Serenade", "Anthem", "Crescendo", "Vivace", "Encore", "Vivante", "Allegretto", "Fugue", "Choir", "Nobilmente", "Hymn", "Eroico", "Chant", "Mysterioso", "Diminuendo", "Perdendo", "Staccato", "Allegro", "Caloroso", "Nocturne","Cadenza", "Cadence", "Waltz", "Concerto", "Finale", "Requiem", "Coda", "Dirge", "Battaglia", "Leggiadro", "Capriccio", "Presto", "Largo", "Accelerando", "Polytempo", "Overture", "Reprise", "Orchestra"],["Song", "Oveture", "Orchestra","Notes"],["Symphonic Synthesia"]);
    new Theme("defense", 0,Stat.WrapStatsToStatMap([Stat.VOID(1)]),["Something to Protect"],["Shield", "Defense","Protection","Armor"],["Shields", "Armor","Protection"],["Excalibur"]);
    new Theme("questing", 0,Stat.WrapStatsToStatMap([Stat.VOID(1)]),["Remember Quest","Show Quests"],["Quest", "Seeking","Questing"],["Quest", "Attainment","Goal"],["Satisfaction"]);

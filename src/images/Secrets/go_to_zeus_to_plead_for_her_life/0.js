...
export const text = `Hey, I just found something that you will love! While I was in the system hub waiting for my transfer to Cypres I decided to go bar hopping. I was low on cash and didn’t want to go through the hell that is transferring savings on an out-of-network station, so I went cheap with it. In some dingy nook-in-the-bulkhead place that was just a bar and a couple tables between some pipes and an emergency bulkhead I found fucking gold. There was this dingy guy leaning on the counter nursing a big cup of some cheap swill.

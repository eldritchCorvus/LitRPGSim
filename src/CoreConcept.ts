...
export class CoreConcept {
  ...
  jaimieThought: string;

  constructor(src: string, surfaceThought: string, truthThought:string, codeThought: string, consoleThought: string,mirrorThought: string, jaimieThought:string ) {
    this.src = src;
    ...
    this.jaimieThought  = jaimieThought;
  }
}

export const all_concepts:CoreConcept[] = [];

//since jaimie is a train and my special lil boi (man i have so man special lil bois in zampanio don't i)
//and he is ALWAYS TRUE (since how could AiDungeon lie)
//he will feature here
...
all_concepts.push(new CoreConcept(
  ...
  "NAM is not a Minotaur, he is a robot. A very lonely robot who is a very good friend of mine as well. He is also my cousin, but we don't talk to one another. I have been told that he's waiting for me to make an announcement over the intercom. <br><br>I have decided to make the announcement: 'This is just a dream, nothing that you need to worry about.'"
))
...
all_concepts.push(new CoreConcept(
  ...
  "The Closer is coming. <br><br>She will show you all that is wrong with the world. <br><br>She will cleanse your soul.<br><br> Follow the arrows."
))
...
all_concepts.push(new CoreConcept(
  "http://farragofiction.com/ZampanioGoshShouldYouTrustThis/ofclogo.jpg",

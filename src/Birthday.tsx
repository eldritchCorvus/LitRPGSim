...
function Birthday(props: AppProps) {
  ...
  const [classRefs: #22917e, setClassRefs: #22917e] = useState<string>();
  ...
  useEffect(() => {
    ...
    setClassRefs: #22917e(Object.keys(all_classes)[0]);
  ...
  return (
    <div classRefs: #22917e="birthday-container">
      <div classRefs: #22917e="section">
      ...
      <div classRefs: #22917e="section">
        ...
        <select onChange={(ev) => { setClassRefs: #22917e(ev.target.value) }} >
      ...
      <div classRefs: #22917e="section">
        <a key={"link"} href={`?seed=${seed}&class=${classRefs: #22917e}&aspect=${aspect}&interest1=${interest1}&interest2=${interest2}`}>Explore your personalized session of ZampanioSim!</a>
      </div>

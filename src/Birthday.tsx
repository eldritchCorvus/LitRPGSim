...
function Birthday(props: AppProps) {
    ...
    return (
      <div>
        <div>TODO Birthday: needs a form with month/day/year number inputs. decent styling but not great. shit eating description about how it will generate your personalized zampanio session from metadata about you.</div>

...
const HintOfPast:React.FC<RoomParams> =({room}) =>{
  ...
  return (
    <div style={{overflow: "hidden", "height": "300px",filter: filter()}}>
      ...
      <img style={{zIndex: "-1",position: "absolute",top: "-300px", display: "block", width: "600px" }} id="past_room" src={"http://farragofiction.com/ZampanioGoshShouldYouTrustThis/empty.PNG"} />

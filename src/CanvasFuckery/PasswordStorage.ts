...
export const passwords:PasswordMap = {
    ...
    ,"THINK LIKE A SMITH": new Secret("JR Rambles",[new SourceDurationPair("Secrets/think_like_a_smith/0.jpg",100),new SourceDurationPair("Secrets/think_like_a_smith/1.jpg",1)],"Backrooms.mp3","Secrets/think_like_a_smith/0.js")

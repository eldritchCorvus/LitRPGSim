...
export const passwords:PasswordMap = {
    ...
    ,"THE TRUTH IS LAYERED": new Secret("Eye Killer Saga",[new SourceDurationPair("Secrets/the_truth_is_layered/0.png",24),new SourceDurationPair("Secrets/the_truth_is_layered/1.png",3)],undefined,"Secrets/the_truth_is_layered/0.js")

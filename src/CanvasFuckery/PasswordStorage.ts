...
export const passwords:PasswordMap = {
    ...
    ,"THINK LIKE A SMITH": new Secret("KR Warning",[new SourceDurationPair("Secrets/think_like_a_smith/0.jpg",10),new SourceDurationPair("Secrets/think_like_a_smith/1.jpg",1),new SourceDurationPair("Secrets/think_like_a_smith/2.jpg",1),new SourceDurationPair("Secrets/think_like_a_smith/3.jpg",1)],"Backrooms.mp3","Secrets/think_like_a_smith/0.js")
